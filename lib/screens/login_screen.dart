...
import 'package:final_project_in_appdev/screens/employee_home_screen.dart'; // ✅ Make sure this exists
import 'package:final_project_in_appdev/models/account.dart';
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (isValid) {
        ...
        if (user != null) {
          ...
          await FlutterSecureStorage().write(key: 'current_user_role', value: user.role); // ✅ Store role
